  ...
  const processor = new MessageProcessor(
    {
      ...
      fastLaneDefaultEnabled: config.JARVIS_FAST_LANE_DEFAULT,
      jobTimeoutMs: config.JARVIS_JOB_TIMEOUT_MS,
      jobTickMs: config.JARVIS_JOB_TICK_MS,
      jobMaxConcurrent: config.JARVIS_JOB_MAX_CONCURRENT,
